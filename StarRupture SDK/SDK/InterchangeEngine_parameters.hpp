...
public:
	...
	struct FImportAssetParameters                 ImportAssetParameters;                             // 0x0018(0x0108)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<class UObject*>                        OutImportedObjects;                                // 0x0120(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FImportAssetParameters                 ImportAssetParameters;                             // 0x0008(0x0108)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<class UObject*>                        OutImportedObjects;                                // 0x0110(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0120(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
