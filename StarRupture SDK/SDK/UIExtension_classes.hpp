...
{
public:
	struct FGameplayTag                           ExtensionPointTag;                                 // 0x0270(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EUIExtensionPointMatch                        ExtensionPointTagMatch;                            // 0x0278(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_279[0x7];                                      // 0x0279(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UObject>>            DataClasses;                                       // 0x0280(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TDelegate<void(class UObject* DataItem)>      GetWidgetClassForData;                             // 0x0290(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TDelegate<void(class UUserWidget* Widget, class UObject* DataItem)> ConfigureWidgetForData;      // 0x02A8(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C0[0x10];                                     // 0x02C0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FUIExtensionHandle, class UUserWidget*> ExtensionMapping;                            // 0x02D0(0x0050)(ExportObject, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
