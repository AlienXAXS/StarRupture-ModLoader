...
#include "BP_ViewportLeft_classes.hpp"
...
void ABP_ViewportLeft_C::GetBuildingMeshes(class UMeshComponent** MainBody, TArray<class UMeshComponent*>* AdditionalMeshes) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ViewportLeft_C", "GetBuildingMeshes");

	Params::BP_ViewportLeft_C_GetBuildingMeshes Parms{};
