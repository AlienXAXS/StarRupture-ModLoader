...
DUMPER7_ASSERTS_FPartyMemberJoinInProgressRequest;
...
DUMPER7_ASSERTS_FPartyMemberJoinInProgressResponse;
...
public:
	...
	struct FPartyMemberPlatformData               PlatformData;                                      // 0x0030(0x0098)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_C8[0xC0];                                      // 0x00C8(0x00C0)(Fixing Size After Last Property [ Dumper-7 ])
	ECrossplayPreference                          CrossplayPreference;                               // 0x0188(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_189[0x47];                                     // 0x0189(0x0047)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 JoinMethod;                                        // 0x01D0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E0[0x40];                                     // 0x01E0(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyMemberJoinInProgressData         JoinInProgressData;                                // 0x0220(0x0048)(NativeAccessSpecifierPrivate)
