...
{
public:
	struct FMovieSceneIntegerChannel              HoursCurve;                                        // 0x0110(0x0120)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              MinutesCurve;                                      // 0x0230(0x0120)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              SecondsCurve;                                      // 0x0350(0x0120)(NativeAccessSpecifierPublic)
	struct FMovieSceneIntegerChannel              FramesCurve;                                       // 0x0470(0x0120)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                SubFramesCurve;                                    // 0x0590(0x0128)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                RateCurve;                                         // 0x06B8(0x0128)(NativeAccessSpecifierPublic)
	struct FMovieSceneStringChannel               Slate;                                             // 0x07E0(0x0128)(NativeAccessSpecifierPublic)
