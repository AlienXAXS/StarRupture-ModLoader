...
{
public:
	TMulticastInlineDelegate<void(const class FString& Response, bool bSuccessful, const struct FHttpHeader& OutHeader)> OnRequestComplete; // 0x0028(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FHttpHeader                            CachedHeader;                                      // 0x0040(0x0050)(NativeAccessSpecifierPrivate)
