...
// ScriptStruct MassRepresentation.MassDisableDefaultISMProcessorTag
// 0x0000 (0x0001 - 0x0001)
struct FMassDisableDefaultISMProcessorTag final : public FMassTag
{
};
DUMPER7_ASSERTS_FMassDisableDefaultISMProcessorTag;
...
{
public:
	uint8                                         Pad_0[0x2028];                                     // 0x0000(0x2028)(Fixing Size After Last Property [ Dumper-7 ])
	class UScriptStruct*                          FilterTag;                                         // 0x2028(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
};
...
public:
	...
	bool                                          bCreatePhysics;                                    // 0x0090(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FTransform>                     TransformOffsets;                                  // 0x0080(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                 CustomDataFloats;                                  // 0x0090(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FStaticMeshInstanceVisualizationDesc   Desc;                                              // 0x0000(0x00A0)(Edit, EditConst, Protected, NativeAccessSpecifierProtected)
	TArray<class UInstancedStaticMeshComponent*>  InstancedStaticMeshComponents;                     // 0x00A0(0x0010)(Edit, ExportObject, ZeroConstructor, EditConst, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TArray<struct FMassLODSignificanceRange>      LODSignificanceRanges;                             // 0x00B0(0x0010)(Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected)
};
