...
// 0x07E0 (0x0C00 - 0x0420)
class UVehicleAnimationInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_418[0x7D8];                                    // 0x0418(0x07D8)(Fixing Size After Last Property [ Dumper-7 ])
	class UChaosWheeledVehicleMovementComponent*  WheeledVehicleComponent;                           // 0x0BF0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
