...
{
public:
	struct FSoftObjectPath                        Path;                                              // 0x00A0(0x0020)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class FName                                   FieldName;                                         // 0x00A4(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PropertyId;                                        // 0x00AC(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRCFieldPathInfo                       FieldPathInfo;                                     // 0x00B8(0x0018)(NativeAccessSpecifierPublic)
	TSet<struct FRemoteControlProtocolBinding>    ProtocolBindings;                                  // 0x00D0(0x0050)(NativeAccessSpecifierPublic)
	struct FSoftClassPath                         OwnerClass;                                        // 0x0120(0x0020)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         ActiveMasks;                                       // 0x0141(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	struct FSoftObjectPath                        FunctionPath;                                      // 0x0160(0x0020)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TSubclassOf<class UObject>                    OriginalClass;                                     // 0x0150(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	struct FMaterialParameterInfo                 ParameterInfo;                                     // 0x0158(0x0010)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRCFieldPathInfo                       OriginalFieldPathInfo;                             // 0x0168(0x0018)(NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        InstancePath;                                      // 0x0180(0x0020)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
