...
public:
	...
	uint8                                         Pad_30[0x15C];                                     // 0x0030(0x015C)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class AReplicationGraphDebugActor> DebugActor;                                    // 0x018C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1A8[0xB0];                                     // 0x01A8(0x00B0)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UReplicationGraphNode*>          ConnectionGraphNodes;                              // 0x0258(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                  // 0x0268(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_270[0x120];                                    // 0x0270(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
