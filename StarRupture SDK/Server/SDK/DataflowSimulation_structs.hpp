...
{
public:
	struct FDataflowSimulationTime                SimulationTime;                                    // 0x0288(0x000C)(Transient, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<class FString>                         SimulationGroups;                                  // 0x0298(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FDataflowSimulationProperty>    PhysicsSolvers;                                    // 0x0298(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FDataflowSimulationProperty>    SimulationProxies;                                 // 0x0288(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<struct FDataflowSimulationProperty>    FilteredProxies;                                   // 0x0298(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<class FString>                         SimulationGroups;                                  // 0x02A8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
