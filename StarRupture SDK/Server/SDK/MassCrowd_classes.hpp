...
{
public:
	struct FMassCrowdClientBubbleSerializer       CrowdSerializer;                                   // 0x02C0(0x0238)(Net, Transient, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	class UMassCrowdSubsystem*                    CrowdSubsystem;                                    // 0x00A0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class UZoneGraphAnnotationSubsystem*          ZoneGraphAnnotationSubsystem;                      // 0x0410(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	class UZoneGraphAnnotationSubsystem*          ZoneGraphAnnotationSubsystem;                      // 0x00D8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	uint8                                         Pad_E4[0x237C];                                    // 0x00E4(0x237C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UZoneGraphSubsystem*                    ZoneGraphSubsystem;                                // 0x0038(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UZoneGraphAnnotationSubsystem*          ZoneGraphAnnotationSubsystem;                      // 0x0040(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class UMassCrowdSettings*                     MassCrowdSettings;                                 // 0x0048(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
{
public:
	struct FZoneGraphTag                          CloseLaneTag;                                      // 0x0598(0x0001)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FZoneGraphTag                          WaitingLaneTag;                                    // 0x0599(0x0001)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDisplayTags;                                      // 0x059A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_59B[0x15];                                     // 0x059B(0x0015)(Fixing Size After Last Property [ Dumper-7 ])
	class UMassCrowdSubsystem*                    CrowdSubsystem;                                    // 0x05B0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
