...
struct BP_AnimNotify_Hammer_PlayFX_C_Received_Notify final
{
public:
	...
	class ABP_Hammer_C*                           K2Node_DynamicCast_AsBP_Hammer;                    // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_AnimNotify_Hammer_PlayFX_C_Received_Notify;
