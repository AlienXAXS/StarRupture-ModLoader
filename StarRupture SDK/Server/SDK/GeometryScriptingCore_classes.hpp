...
{
public:
	static class UDynamicMesh* AutoLevelVertexColorsPerChannel(class UDynamicMesh* TargetMesh, const bool NormalizeRed, const bool NormalizeGreen, const bool NormalizeBlue, const bool NormalizeAlpha, class UGeometryScriptDebug* Debug);
