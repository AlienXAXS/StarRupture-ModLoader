...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Protected, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FGameplayTag&              ExtensionPointTag                                      (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// TDelegate<void(EUIExtensionAction Action, const struct FUIExtensionRequest& ExtensionRequest)>ExtensionCallback                                      (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
