...
public:
	...
	EGameplayCamerasViewRotationMode              ViewRotationMode;                                  // 0x2808(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverrideViewRotationMode;                         // 0x280C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_280D[0x3];                                     // 0x280D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerCameraManager*                   OriginalCameraManager;                             // 0x2810(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_2818[0x8E8];                                   // 0x2818(0x08E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UCameraAsset*                           Camera;                                            // 0x02C8(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class UCameraAsset*                           GeneratedCameraAsset;                              // 0x03B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	struct FMovieSceneDoubleChannel               LeftMarginCurve;                                   // 0x0118(0x0130)(NativeAccessSpecifierPublic)
	struct FMovieSceneDoubleChannel               TopMarginCurve;                                    // 0x0248(0x0130)(NativeAccessSpecifierPublic)
	struct FMovieSceneDoubleChannel               RightMarginCurve;                                  // 0x0378(0x0130)(NativeAccessSpecifierPublic)
	struct FMovieSceneDoubleChannel               BottomMarginCurve;                                 // 0x04A8(0x0130)(NativeAccessSpecifierPublic)
