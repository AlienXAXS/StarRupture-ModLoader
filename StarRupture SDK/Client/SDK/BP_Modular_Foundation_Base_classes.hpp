...
// BlueprintGeneratedClass BP_Modular_Foundation_Base.BP_Modular_Foundation_Base_C
// 0x0030 (0x0870 - 0x0840)
class ABP_Modular_Foundation_Base_C : public ACrFoundation
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Modular_Foundation_Base_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Modular_Foundation_Base_C")
	}
	static class ABP_Modular_Foundation_Base_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Modular_Foundation_Base_C>();
	}
};
DUMPER7_ASSERTS_ABP_Modular_Foundation_Base_C;
