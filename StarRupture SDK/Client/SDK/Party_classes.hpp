...
public:
	...
	TArray<class USocialToolkit*>                 SocialToolkits;                                    // 0x00A8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class USocialDebugTools*                      SocialDebugTools;                                  // 0x00B8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class USocialChatManager*                     SocialChatManager;                                 // 0x0068(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class USocialUser*                            LocalUser;                                         // 0x0070(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	TArray<class USocialUser*>                    AllUsers;                                          // 0x0078(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	...
	uint8                                         Pad_E4[0x264];                                     // 0x00E4(0x0264)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class USocialUser*                            TargetUser;                                        // 0x0110(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	uint8                                         Pad_264[0x16C];                                    // 0x0264(0x016C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7A[0xCE];                                      // 0x007A(0x00CE)(Fixing Struct Size After Last Property [ Dumper-7 ])
