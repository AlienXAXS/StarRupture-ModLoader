...
void UCommonSessionSubsystem::FindSessions(class APlayerController* SearchingPlayer, class UCommonSession_SearchSessionRequest* Request, const class FString& InIPAddress, const class FString& InPort)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const class FString&                    NewNickname                                            (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UCommonUserInfo::SetNickname(const class FString& NewNickname, ECommonUserOnlineContext Context)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("CommonUserInfo", "SetNickname");

	Params::CommonUserInfo_SetNickname Parms{};
...
class FString UCommonUserInfo::GetNickname(ECommonUserOnlineContext Context) const
{
	static class UFunction* Func = nullptr;
...
// const struct FCommonUserInitializeParams&Params_0                                               (Parm, ContainsInstancedReference, NativeAccessSpecifierPublic)
