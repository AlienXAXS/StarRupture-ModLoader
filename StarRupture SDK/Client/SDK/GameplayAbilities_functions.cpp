...
// TDelegate<void(const struct FGameplayTag& Tag, int32 TagCount)>GameplayTagChangedEventWrapperDelegate                 (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// TDelegate<void(class AActor* Target, const struct FGameplayTag& GameplayTag, const struct FGameplayCueParameters& Parameters, EGameplayCueEvent Event)>InGameplayCueTrackHandler                              (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
