...
struct BP_WaterExtractorFoundation_C_ExecuteUbergraph_BP_WaterExtractorFoundation final
{
public:
...
struct BP_WaterExtractorFoundation_C_ReceiveActorBeginOverlap final
{
public:
	class AActor*                                 OtherActor;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_WaterExtractorFoundation_C_ReceiveActorBeginOverlap;

// Function BP_WaterExtractorFoundation.BP_WaterExtractorFoundation_C.ReceiveTick
// 0x0004 (0x0004 - 0x0000)
struct BP_WaterExtractorFoundation_C_ReceiveTick final
{
public:
	float                                         DeltaSeconds;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_WaterExtractorFoundation_C_ReceiveTick;
