...
{
public:
	struct FMassCrowdClientBubbleSerializer       CrowdSerializer;                                   // 0x02C0(0x0288)(Net, Transient, Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FZoneGraphTag                          CloseLaneTag;                                      // 0x05B8(0x0001)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FZoneGraphTag                          WaitingLaneTag;                                    // 0x05B9(0x0001)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDisplayTags;                                      // 0x05BA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_5BB[0x15];                                     // 0x05BB(0x0015)(Fixing Size After Last Property [ Dumper-7 ])
	class UMassCrowdSubsystem*                    CrowdSubsystem;                                    // 0x05D0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
