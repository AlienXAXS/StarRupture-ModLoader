...
{
public:
	struct FMovieSceneBoolChannel                 ParameterCurve;                                    // 0x0008(0x0120)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x0020(0x0128)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0038(0x0120)(Protected, NativeAccessSpecifierProtected)
};
