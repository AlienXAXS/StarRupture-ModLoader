...
#include "BP_Modular_Foundation_Unique_parameters.hpp"
...
// Function BP_Modular_Foundation_Unique.BP_Modular_Foundation_Unique_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)

void ABP_Modular_Foundation_Unique_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Modular_Foundation_Unique_C", "ReceiveBeginPlay");
...
void ABP_Modular_Foundation_Unique_C::GetBuildingMeshes(class UMeshComponent** MainBody, TArray<class UMeshComponent*>* AdditionalMeshes) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Modular_Foundation_Unique_C", "GetBuildingMeshes");

	Params::BP_Modular_Foundation_Unique_C_GetBuildingMeshes Parms{};
