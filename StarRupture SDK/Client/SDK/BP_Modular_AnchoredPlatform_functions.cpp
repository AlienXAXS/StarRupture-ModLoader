...
#include "BP_Modular_AnchoredPlatform_classes.hpp"
...
void ABP_Modular_AnchoredPlatform_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Modular_AnchoredPlatform_C", "UserConstructionScript");
...
void ABP_Modular_AnchoredPlatform_C::GetBuildingMeshes(class UMeshComponent** MainBody, TArray<class UMeshComponent*>* AdditionalMeshes) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Modular_AnchoredPlatform_C", "GetBuildingMeshes");

	Params::BP_Modular_AnchoredPlatform_C_GetBuildingMeshes Parms{};
