...
#include "BTTask_Animal_Crab_SetTentaclesState_classes.hpp"
#include "BTTask_Animal_Crab_SetTentaclesState_parameters.hpp"
...
void UBTTask_Animal_Crab_SetTentaclesState_C::ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BTTask_Animal_Crab_SetTentaclesState_C", "ReceiveExecuteAI");

	Params::BTTask_Animal_Crab_SetTentaclesState_C_ReceiveExecuteAI Parms{};
