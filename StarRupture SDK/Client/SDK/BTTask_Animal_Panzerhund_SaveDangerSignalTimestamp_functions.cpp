...
#include "BTTask_Animal_Panzerhund_SaveDangerSignalTimestamp_classes.hpp"
#include "BTTask_Animal_Panzerhund_SaveDangerSignalTimestamp_parameters.hpp"
...
void UBTTask_Animal_Panzerhund_SaveDangerSignalTimestamp_C::ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BTTask_Animal_Panzerhund_SaveDangerSignalTimestamp_C", "ReceiveExecuteAI");

	Params::BTTask_Animal_Panzerhund_SaveDangerSignalTimestamp_C_ReceiveExecuteAI Parms{};
