...
#include "BP_Modular_ConnectingPlatform_Triangular_classes.hpp"
...
void ABP_Modular_ConnectingPlatform_Triangular_C::GetBuildingMeshes(class UMeshComponent** MainBody, TArray<class UMeshComponent*>* AdditionalMeshes) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Modular_ConnectingPlatform_Triangular_C", "GetBuildingMeshes");

	Params::BP_Modular_ConnectingPlatform_Triangular_C_GetBuildingMeshes Parms{};
