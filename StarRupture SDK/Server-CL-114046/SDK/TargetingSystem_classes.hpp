...
{
public:
	TMulticastInlineDelegate<void(const struct FTargetingRequestHandle& TargetingRequestHandle)> OnTargetReady; // 0x0080(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	TMulticastInlineDelegate<void(const struct FTargetingRequestHandle& TargetingHandle)> Targeted;  // 0x0030(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UTargetingPreset*                       TargetingPreset;                                   // 0x0048(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	TWeakObjectPtr<class AActor>                  WeakSourceActor;                                   // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class AActor*>                         InitialTargets;                                    // 0x0058(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	struct FTargetingRequestHandle                TargetingHandle;                                   // 0x0068(0x0004)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         bUseAsyncTargeting : 1;                            // 0x006C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
