...
{
public:
	struct FLiveLinkSubjectPreset                 SubjectPreset;                                     // 0x0110(0x0038)(NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<bool>                                  ChannelMask;                                       // 0x0148(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UMovieSceneLiveLinkSubSection*>  SubSections;                                       // 0x0158(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
	uint8                                         Pad_168[0x10];                                     // 0x0168(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SubjectName;                                       // 0x0178(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TSubclassOf<class ULiveLinkRole>              TrackRole;                                         // 0x0150(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
