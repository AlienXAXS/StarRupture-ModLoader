...
public:
	...
	TSet<TSubclassOf<class UObject>>              RegisteredTranslatorsClass;                        // 0x0268(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, TSubclassOf<class UObject>> RegisteredFactoryClasses;           // 0x02B8(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, class UInterchangeWriterBase*> RegisteredWriters;               // 0x0308(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, class UInterchangeAssetImportDataConverterBase*> RegisteredConverters; // 0x0358(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	uint8                                         Pad_3A8[0x88];                                     // 0x03A8(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
