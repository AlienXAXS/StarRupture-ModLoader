...
{
public:
	TMap<class FName, struct FCustomizedToolMenuNameArray> EntryOrder;                               // 0x01A8(0x0050)(NativeAccessSpecifierPublic)
	TArray<class FName>                           SectionOrder;                                      // 0x01F8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
