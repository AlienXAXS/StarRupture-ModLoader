...
struct BP_SmallMeteOre_C_ExecuteUbergraph_BP_SmallMeteOre final
{
public:
	...
	class AFieldSystemActor*                      K2Node_DynamicCast_AsField_System_Actor;           // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AFS_Explosion_C*                        K2Node_DynamicCast_AsFS_Explosion;                 // 0x0088(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_SmallMeteOre_C_ExecuteUbergraph_BP_SmallMeteOre;
