...
// Function BP_AN_StopWeaponMontage.BP_AN_StopWeaponMontage_C.Received_Notify
// 0x0098 (0x0098 - 0x0000)
struct BP_AN_StopWeaponMontage_C_Received_Notify final
{
public:
	...
	float                                         CallFunc_GetDefaultBlendOutTime_ReturnValue;       // 0x005C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCrWeaponComponent*                     CallFunc_GetComponentByClass_ReturnValue;          // 0x0068(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class ACrWeaponActor*                         CallFunc_GetEquippedWeaponActor_ReturnValue;       // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_AN_StopWeaponMontage_C_Received_Notify;
