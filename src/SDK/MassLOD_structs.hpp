...
{
public:
	class AActor*                                 ActorViewer;                                       // 0x0000(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	uint8                                         Pad_0[0x2030];                                     // 0x0000(0x2030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
