...
public:
	...
	TDelegate<void(class UObject* Object)>        OnAssetDone;                                       // 0x0040(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_58[0x18];                                      // 0x0058(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const TArray<class UObject*>& Objects)> OnAssetsImportDone;                       // 0x0070(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_88[0x18];                                      // 0x0088(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Object)>        OnSceneObjectDone;                                 // 0x00A0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B8[0x18];                                      // 0x00B8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const TArray<class UObject*>& Objects)> OnSceneImportDone;                        // 0x00D0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
