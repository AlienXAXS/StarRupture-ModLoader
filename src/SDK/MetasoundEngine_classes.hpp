...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x04A0(0x0190)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0630(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0680(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x06D0(0x0050)(Protected, NativeAccessSpecifierProtected)
	EMetaSoundOutputAudioFormat                   OutputFormat;                                      // 0x0720(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_721[0x17F];                                    // 0x0721(0x017F)(Fixing Struct Size After Last Property [ Dumper-7 ])
