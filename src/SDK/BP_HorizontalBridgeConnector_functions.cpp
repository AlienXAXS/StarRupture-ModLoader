...
#include "BP_HorizontalBridgeConnector_classes.hpp"
...
void ABP_HorizontalBridgeConnector_C::GetBuildingMeshes(class UMeshComponent** MainBody, TArray<class UMeshComponent*>* AdditionalMeshes) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HorizontalBridgeConnector_C", "GetBuildingMeshes");

	Params::BP_HorizontalBridgeConnector_C_GetBuildingMeshes Parms{};
