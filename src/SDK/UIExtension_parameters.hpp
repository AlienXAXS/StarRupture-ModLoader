...
public:
	...
	TDelegate<void(EUIExtensionAction Action, const struct FUIExtensionRequest& ExtensionRequest)> ExtensionCallback; // 0x0020(0x0018)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FUIExtensionPointHandle                ReturnValue;                                       // 0x0038(0x0018)(Parm, OutParm, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
