...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Modular_Railing_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Modular_Railing_C")
	}
	static class ABP_Modular_Railing_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Modular_Railing_C>();
	}
};
DUMPER7_ASSERTS_ABP_Modular_Railing_C;
