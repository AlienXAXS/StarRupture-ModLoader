...
namespace ScanPatterns
{
	...
	inline constexpr const char* UCrMassSaveSubsystem_OnSaveLoaded = 
	...
	inline constexpr const char* UCrExperienceManagerComponent_OnExperienceLoadComplete = 
		"48 89 4C 24 ?? 55 53 56 41 54 41 55 48 8D 6C 24 ?? 48 81 EC ?? ?? ?? ?? 83 B9";

	// FMassEntityManager::GetArchetypeForEntity(FMassEntityHandle)
	inline constexpr const char* FMassEntityManager_GetArchetypeForEntity = 
	...
	inline constexpr const char* ACrGameModeBase_PostLogin =
