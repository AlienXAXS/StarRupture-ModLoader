...
//
// Settings can be configured via modloader.ini in the [Logging] section:
//   Level=DEBUG  ; Minimum log level (TRACE, DEBUG, INFO, WARN, ERROR)
//   EnableFile=1      ; Enable file logging
//   FileName=modloader.log ; Log file name
//
		...
		if (attribs == INVALID_FILE_ATTRIBUTES)
		{
			...
			if (hFile != INVALID_HANDLE_VALUE)
			{
				const char* defaultContent =
					...
					"Enabled=0\n\n"
					"; Path to UE4SS DLL, relative to the game exe\n"
